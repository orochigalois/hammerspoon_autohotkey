...
`::
{
   ...
   DetectHiddenWindows, Off	
	...
	if status = 0
	{
		...
		IfWinNotExist ahk_class Microsoft-Windows-SnipperEditor
	{
		WinShow, ahk_class Microsoft-Windows-SnipperEditor
		WinActivate, ahk_class Microsoft-Windows-SnipperEditor
	}
	Else
		IfWinExist, ahk_class Microsoft-Windows-SnipperEditor
	{
		WinMinimize, ahk_class Microsoft-Windows-SnipperEditor
		WinHide, ahk_class Microsoft-Windows-SnipperEditor
	}
	Return
}
...
counter--
if(counter=10){
   ComObjCreate("SAPI.SpVoice").Speak("Five")
}
if(counter=8){
   ComObjCreate("SAPI.SpVoice").Speak("Four")
}
if(counter=6){
   ComObjCreate("SAPI.SpVoice").Speak("Three")
}
if(counter=4){
   ComObjCreate("SAPI.SpVoice").Speak("Two")
}
if(counter=2){
   ComObjCreate("SAPI.SpVoice").Speak("One")
}
if (counter=0){
SetTimer, UpdateOSD, off ; stops the counter
ComObjCreate("SAPI.SpVoice").Speak("Time up")
Gui, Color, black
